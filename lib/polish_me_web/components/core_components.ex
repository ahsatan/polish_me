defmodule PolishMeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PolishMeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PolishMeWeb.Gettext, "errors", msg, opts)
    end
  end
